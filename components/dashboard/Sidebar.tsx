...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 bg-[#151922] w-64 flex flex-col z-40 transform shadow-2xl ${
    ...
    >
      ...
      <div className="flex flex-col items-center py-8 border-b border-gray-800 bg-[#1A1F29]">
        <h2 className="text-blue-400 text-lg font-bold mb-4">Welcome User</h2>
